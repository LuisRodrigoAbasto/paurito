    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button
            type="button"
            @click="mostrarDetalle('egreso','registrar')"
                ...
                <tbody>
                  ...
                  <td>
                    ...
                    <td>
                      ...
                      <button
                        type="button"
                        @click="mostrarDetalle('egreso','actualizar',data)"
